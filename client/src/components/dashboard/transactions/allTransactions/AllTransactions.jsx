...
export default function AllTransactions({user}) {
  return (
    <div>
        ...
        <ul>
            <li><div>Renders all outstanding transactions</div></li>
            <li><div>Transactions are sorted by how recent they are</div></li>
            <li><div>Displayed in groups based on how long it's been (today, yesterday, last week, last month...)</div></li>
        </ul>
    </div>
  )
}
